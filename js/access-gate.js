        ...
        '<div class="baby-hero__shell">' +
          '<section class="baby-hero__identity" aria-label="Giới thiệu bé">' +
            ...
            '<div class="baby-hero__identity-row">' +
              '<div class="baby-hero__avatar" aria-hidden="true"><span id="profileInitials">YK</span></div>' +
              '<div class="baby-hero__title-block">' +
                '<h1 class="baby-hero__name" id="profileName">Ý Khuê</h1>' +
          ...
          '<aside class="baby-hero__memory-card" aria-label="Hồ sơ chào đời">' +
            '<div class="memory-card__heading">' +
              ...
              '<span class="memory-card__seal" id="profileSeal" aria-hidden="true">YK</span>' +
            '</div>' +
            '<div class="memory-card__date">' +
              '<strong id="birthDay">08</strong><span id="birthMonthYear">Tháng 12<br>2022</span>' +
            '</div>' +
